...
class Batman07 extends Person07 {
...
class Superman07 extends Human07 {
...
public class P07 {
  ...
  public static void main(String[] args) {
    ...
    Person07[] persons = new Person07[10];		//--- 이건 Person 전용 --;;
    persons[0] = new Person07();
    persons[1] = new Person07();
    persons[2] = new Batman07();

    Batman07[] batmans = new Batman07[10];	//--- 이건 Batman 전용 --;;
    batmans[0] = new Batman07();
    batmans[1] = new Batman07();
    // batmans[2] = new Person();			//--- Err


    // [2] : 배열에서 다형성을 사용할 수 있기에..
    Human07[] humans = new Human07[10];
    humans[0] = new Human07();
    humans[1] = new Superman07();
    ...
    System.out.println( new Person07() );
    System.out.println( new Batman07() );
    System.out.println( new Human07() );
    System.out.println( new Superman07() );
