...
// 문제
//FarmMachine 의 속성과 동작들을 가지는 클래스를 코드로 구현하고 객체를 생성하여 동작 시켜보시오
//이 문제는 어떤 사물에 대한 클래스를 실제 코드로 구현할 수 있는지 를 묻는 문제이다
...
class FarmMachine {
  ...
  void move() {
    System.out.println(price + "의 농기계 is moving." );
  }

  void dig() {
    System.out.println( year + "의 농기계 is digging." );
  }

  void grind() {
    System.out.println( color + "의 농기계 is digging." );
  }
...
public class Exam002 {
  ...
  public static void main(String[] args) {
    ...
    // 객체는 참조형 타입이므로 fm을 찍어보면 이상한 주솟값이 나온다.

    System.out.println("-----------------");
    System.out.println( fm ); // 이상한 값 출력
    System.out.println("-----------------");
