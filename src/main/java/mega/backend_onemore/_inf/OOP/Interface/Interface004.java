...
class Person04 {
  ...
  Person04(String name, int age, int weight) {
    this.name = name;
    this.age = age;
    this.weight = weight;
  }
...
class Student04 extends Person04 implements Allowance04, Train04 {
  // Field
  ...
  Student04(String name, int age, int weight) {
...
public class Interface004 {
  ...
  public static void main(String[] args) {
    ...
    // [1] : 객체 생성
    Student04 s1 = new Student04("홍길동", 20, 85);
    ...
    System.out.println(Allowance04.aaa);  // 코리아
    System.out.println(Allowance04.bbb);  // 100
